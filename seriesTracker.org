...
Series lists and episodes are represented as vectors of alists.
Select a list of elements from each alist in a vector.
...
Same elements in each alist in a vector consitute a column.
...
Apply a function to all values of a column in a vector.
